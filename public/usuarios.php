...
<!-- ============================================
     HEADER + TABS
     ============================================ -->
<section x-data="{ tab: '<?= e($tab) ?>' }" class="mb-6">
  ...
  <!-- Pestanas -->
  <div class="flex gap-1 border-b-2 border-rose-100 overflow-x-auto">
...
<!-- ============================================
     TAB: USUARIOS
     ============================================ -->
<div x-data="{ tab: '<?= e($tab) ?>' }" x-show="tab === 'users'" x-cloak>
...
<!-- ============================================
     ...
     ============================================ -->
<div x-data="{ tab: '<?= e($tab) ?>' }" x-show="tab === 'catalogo'" x-cloak>
